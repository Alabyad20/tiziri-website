# TIZIRI Instagram Launch Pack — Posting Plan

Everything you need is in this folder (`rug-photos/July 4th Photoshoot/Instagram Ready/`) plus a handful of photos referenced by path below. Work through it top to bottom. All reels already have original audio stripped and a music track added — safe to post as-is.

---

## Step 0 — Profile setup (once, before Day 1)

- **Name field:** TIZIRI
- **Username:** @tizirirugs
- **Category:** Home decor
- **Bio:**
  > Berber rugs sourced directly from weavers in Morocco.
  > No wholesalers. No duplicates.
  > tizirirugs.com
- **Link:** https://tizirirugs.com
- Switch to a **Business account** (free) so you get insights and can add the Shop tab later.
- Profile photo: use the TIZIRI logo from `rug-photos/July 4th Photoshoot/logos/`.

**Posting mechanics (applies to everything below):**
- Post between **6–8 pm ET** (evening scroll, US East Coast buyers).
- Add location tag **Boston, Massachusetts** on product posts — "ships from the US" is a selling point; the rugs really are here.
- After posting, **share each post to your Story** the same evening (one tap) — doubles the reach for free.
- For reels, pick a **cover frame** where the whole rug is visible (Instagram asks when you post).
- Reply to every comment in the first hour if you can — the algorithm rewards it.

---

## Phase 1 — Launch week

### Day 1 — Feed photo: Brand intro
**Photo:** `July 4th Photoshoot/300x220 Cm/IMG_20260704_152627.jpg` (Hafsa — same rug featured on the homepage)

> I started TIZIRI because I couldn't find a Moroccan rug in the US that was sourced the way I'd source one myself.
>
...
### Day 5 — Feed photo: Where it comes from
**Photo:** `rug-photos/IMG-20260604-WA0056.jpg` (rug on the rooftop terrace, Atlas mountains behind)
...
## Phase 2 — Steady cadence (3 posts/week: Mon / Wed / Fri or Sat)

Post in this order. Two reels + interleaved feed posts per week keeps the grid varied (never two of the same style back to back).
...
**F3 — Feed photo: No duplicates manifesto** — `July 4th Photoshoot/284x212 Cm/IMG_20260704_150507.jpg` (Assia)
> Every rug in this collection exists once.
>
...
**F4 — Feed photo: The texture post** — pick the tightest close-up from `July 4th Photoshoot/290x199cm/` (Tafat's folder — the carved grey pile)
> You know it when you stand on it.
>
...
>
> tizirirugs.com/made-to-order
>
> #MadeToOrder #CustomRug #MoroccanRug #InteriorDesign #BespokeHome #HandwovenRug
...
**F6 — Feed carousel: Collection recap** — pick 5–8 favourite full-rug shots (suggestions: Hafsa `300x220 Cm/IMG_20260704_152627.jpg`, Samia `242x159cm/IMG_20260704_183753.jpg`, Malak `243x152 cm/IMG_20260704_175742.jpg`, Sanaa `253x148 cm/IMG_20260704_175236.jpg`, Najat `305x192cm/IMG_20260704_121506.jpg`)
> The first TIZIRI collection is live.
>
> 27 rugs. No two alike. Selected in person in Morocco, shipped from the US.
>
> tizirirugs.com
>
> #MoroccanRug #NewCollection #InteriorDesign #HandwovenRug #BerberRug #OneOfAKind #HomeDecor

---

## Extra material (use anytime, no schedule)
...
- Rania has only 1 photo and no reel — she joins the calendar after her reshoot.
- When a rug **sells**, don't delete its post — comment/edit caption "SOLD — join the newsletter at tizirirugs.com for the next arrival."
- Captions reuse the live site descriptions — no invented claims. Keep it that way if you tweak wording.

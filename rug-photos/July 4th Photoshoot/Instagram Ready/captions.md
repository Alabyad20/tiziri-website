...
All clips: original phone audio removed, replaced with a track from the `Music/` folder, trimmed to ~15-20s. Captions reuse the real product description already live on the site — no invented claims.

---

**warda_reel.mp4** — Warda (Contemporary)
...
**Not turned into a product reel** (different genre — flag if you want these used separately):
- Bouchra's shoot also has 2 clips of you presenting the rug on camera (talking to camera, holding it up) — good "meet the maker" content, distinct from bouchra_reel.mp4 above.
- Sanaa's and Sabrine's raw clips also show you partially in frame holding the rug up before the camera settles on the rug — kept in these edits since it reads as an authentic reveal moment, not cut away.
